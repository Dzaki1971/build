...
ANYKERNEL_REPO="https://github.com/Dzaki1971/anykernel.git" 
ANYKERNEL_BRANCH="master"

# Compiler
CLANG_DIR="${HOME}"/root/kernel/clang
#if ! [ -d "${CLANG_DIR}" ]; then
...
# Costumize
KERNEL="ppk_kernel"
RELEASE_VERSION="ayangYandu"
DEVICE="Mojito"
KERNELTYPE="NonOC-NonTreble"
KERNEL_SUPPORT="11 - 13"
...
# Telegram
CHATIDQ="-4094421676"
CHATID="-4094421676" # Group/channel chatid (use rose/userbot to get it)
TELEGRAM_TOKEN="6368314260:AAHfAFw5jaLskZ-MQNRD4LHHxIJRVlAGVFU" # Get from botfather
